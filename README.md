...
Nethereum eShop, a partially decentralised shopping cart based on https://github.com/dotnet-architecture/eShopOnWeb. The ["IBuySpy Store"](#why-the-ibuyspy-store) for Ethereum. The aims are to:
1) Show you **why** you might want to integrate an online shop with Ethereum.
2) Show you **how easy** it is to do so.
